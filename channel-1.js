...
async function getURLwithToken() {
    ...
    if (!token) {
        ...
        const url = 'https://chromecast.cvattv.com.ar/live/c3eds/ESPN2HD/SA_Live_dash_enc_c/ESPN2HD.m3u8';
